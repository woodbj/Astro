...
from Astro.utilities import FileManager, Exposure
...
def start_camera():
    ...
    try:
        ...
        if result is True:
            ...
            return jsonify({"success": False, "error": "Camera not detected. Please check connection."}), 500
